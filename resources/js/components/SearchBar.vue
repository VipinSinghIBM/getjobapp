            ...
            <div class="row m-1">
              <div class="col-md-12 input-group">
                <input
                  ...
                  name="q"
                  class="form-control"
                  placeholder="Search Job's By Title"
                  v-model="JobTitle"
                />
                <span class="input-group-append">
                  <button class="btn btn-success pt-1" @click="searchByTitle">
                    <span class="icon-search"></span> Search Job's
                  </button>
                </span>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-3">
              <router-link to="/jobs-by-organization"
                >Job's By Organisation</router-link
              >
            </div>
            <div class="col-sm-6 col-md-3">
              <router-link to="/jobs-by-category">Job's By Category</router-link>
            </div>
            <div class="col-sm-6 col-md-3">
              <router-link to="/jobs-by-title">Job's By Title</router-link>
            </div>
          </div>
        </div>
      </div>
