        ...
        <div class="col-sm-12 col-md-6 px-0">
            <div class="login-container">
                <div class="login-header mb-3">
                    <h3> <img src="{{asset('images/logo.png')}}" width="150px;" alt="">Reset Password</h3>
                    <p class="login-header-title">Welcome to Getjob Job Portal</p>
                    <p class="text-muted">Enter Your Registered E-mail To Reset Your Password</p>
                </div>
                <div class="login-form">
                    ...
                    <form action="{{route('forget.password.post')}}" method="POST">
                        ...
                        <button type="submit" class="btn primary-btn btn-block">Send Reset Password Link</button>
                    </form>
                    <div class="my-3">
