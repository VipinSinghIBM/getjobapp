    ...
    <div class="row justify-content-center">
        <div class="col-sm-12 col-md-6 px-0">
            ...
            <div class="login-poster">
                ...
                <p class="text-white mb-3 lead"><i class="fas fa-angle-right"></i> Most Trusted Job Portal in India</p>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-md-6 px-0">
            <div class="login-container">
                <div class="login-header mb-3">
                    <h3><img src="{{asset('images/logo.png')}}" width="150px;" alt=""> Create your free Account</h3>
                ...
                <div class="login-form">
                    <form action="{{route('register')}}" method="POST">
                        ...
                        <div>
                            <small class="text-muted d-block mb-3">By clicking on 'Create Jobseeker Account' below you are agreeing to the terms and smallrivacy of GetJob!</p>
                        </div>
