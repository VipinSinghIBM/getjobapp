  ...
  <div class="account-layout border">
    ...
    <div class="account-bdy p-3">
     <form action="{{route('company.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="pb-3">
          <div class="py-3">
            <p>Company logo (If You Don't Have Own Logo. System Genrate Automatically)</p>
          </div>
        ...
        <div class="form-group">
          <div class="py-3">
            <p>Company Title(Enter Your Company Title Exa:- Paytm, Grocerry, ABC HR Solutinos)</p>
          </div>
        ...
        <div class="form-group">
          <div class="py-3">
            <p>Company Website URL Or Your Contact Detail's <b>For exampe You Don't Have Website Then Give Your Whatsapp OR Telegram Link That User Can Reach Easily</b></p>
            <p class="text-primary"> For Example:- Your Whatsapp No. is +91 00000 00000 <b> Then Use:-> https://wa.me/91000000000</b> Don't use: https://wa.me/+91-(000) 0000000</p>
          </div>
