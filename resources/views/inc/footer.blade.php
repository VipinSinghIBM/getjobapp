  ...
  <div class="footer-main">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            <h3 class="footer-brand mb-2"><a href="{{URL('/')}}" class="navbar-brand">
              <img src="{{asset('images/logo.jpg')}}" height="70" width="250" alt="Natural"/>
              </a></h3>
            <div class="footer-link-list">
             <a href="#" class="footer-links"><i class="fas fa-compass"></i> NSTI Calicut, Govindapuram Kerala Pin-673016</a>
             <a href="tel:98400001511" class="footer-links"><i class="fas fa-phone"></i> +91 9876543210</a>
             <a href="tel:98400001511" class="footer-links"><i class="fas fa-mobile"></i> +91 0123456789</a>
             <a href="mailto:naukaripao94@gmail.com" class="footer-links"><i class="fas fa-envelope"></i> naukripao94@gmail.com</a>
